...
public class Manager {
     ...
     */
    static Manager getInstance() throws SpotsForVolunteeringException {
        if (instance == null) {
    ...
    public ActivityInfo createActivity(AuthenticatedVolunteerInfo authenticatedVolunteerInfo, ActivityInfo activityInfo) throws SpotsForVolunteeringException {
        ...
        activityInfo.setOwnerId(authenticatedVolunteerInfo.getId());
